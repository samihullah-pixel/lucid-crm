...
const UI = {
  de: {
    ...
    stepsDesc: "Fahrerkabine, Innenraum, Kontrolle",
    access: "Wasser & Zugang",
    accessDesc: "Wo es Wasser gibt · Schlüssel & Türen",
    emergency: "Notfall",
    emergencyDesc: "Person im Bus? → Leitstelle anrufen",
  ...
  en: {
    ...
    stepsDesc: "Driver cab, interior, final check",
    access: "Water & access",
    accessDesc: "Where to find water · keys & doors",
    emergency: "Emergency",
    emergencyDesc: "Someone on the bus? → call control",
    ...
    emergencyFallback:
      "Someone still on the bus (asleep / left behind)? Don't wake them yourself – call the control room immediately.",
  ...
  es: {
    ...
    stepsDesc: "Cabina, interior, control final",
    access: "Agua y acceso",
    accessDesc: "Dónde hay agua · llaves y puertas",
    emergency: "Emergencia",
    emergencyDesc: "¿Alguien en el autobús? → llama a control",
    ...
    emergencyFallback:
      "¿Alguien sigue en el autobús (dormido / olvidado)? No lo despiertes tú – llama de inmediato a la central.",
