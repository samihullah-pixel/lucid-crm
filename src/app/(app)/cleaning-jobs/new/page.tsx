  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="font-sans text-sm font-light text-grey">Erfasse einen durchgefuehrten oder geplanten Einsatz.</p>
      </div>
      <CleaningJobForm customers={customers} properties={properties} employees={employees} />
    </div>
  );
}
